...
class Hyperparameters():
    # Hyperparameters necessary for the job of making BipedalWalker walk
    def __init__(self,
                 nb_steps=NUM_STEPS,
                 episode_length=2000,
                 learning_rate=0.02,
...
if __name__ == '__main__':
    #choose how many trials the bipedal walker does before stopping the training
    parser = argparse.ArgumentParser()
    parser.add_argument("--steps", type=int, default=NUM_STEPS, help="Number of steps to stop training, default=%d" % NUM_STEPS)
    args = parser.parse_args()
    videos_dir = mkdir('.', 'videos')
    monitor_dir = mkdir(videos_dir, ENV_NAME)
    #storing videos in the directory /videos/BipedalWalker-v2
    hp = Hyperparameters(seed=1946, env_name=ENV_NAME, nb_steps=args.steps)
